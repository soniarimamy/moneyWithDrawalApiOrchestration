...
c-1) For those who won't containerize this app with docker, type the below command to run directly the app and jump in _**step IV**_
> python3 moneyWithdrawalApiOrchestration-core.py

c-2) For those who want to use containerization with docker, follow the _**step III**_</b>

### **Step III - CONTAINERIZE MONEY WITHDRAW ORCHESTRATION API WITH DOCKER AND DOCKER-COMPOSE**</br>

a) After installing all requirements, you should run the below command to create docker image
> docker build -f Dockerfile -t bfv/money_with_drawal_api_orchestration_prod:1.0 .

b) Then after creating moneyWithDrawOrchestrationapi docker image, run the below command to launch the container
> docker-compose up -d

### **Step IV - TEST MONEY WITHDRAW ORCHESTRATION API**</br>
